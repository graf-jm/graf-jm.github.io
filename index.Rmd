...
### The Basics
  ...
  <a href="https://docserv.uni-duesseldorf.de/servlets/DerivateServlet/Derivate-45555/Graf%2C%20Jonas%20Dissertation%202017.pdf">Read My Thesis</a>
    <br><br>
  <a href="https://drive.google.com/file/d/1aC76MhP-4AOjEyv9OUjho5RgqVJ2JYKg/view">Read My CV</a>
  <br><br>
  </div>
  <div class = "col-md-4">
...
library(ggplot2)
library(plotly)
p<-ggplot(get_citation_history("J5AuPUQAAAAJ")[1:7,], aes(year, cites)) + geom_line() + geom_point()
